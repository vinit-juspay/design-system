...
import {
  ...
  DropdownInputState,
  DropdownPosition,
} from '../../../lib/components/DropdownInput/types';
...
const InputDemo = () => {
  ...
  const mapTextInputStateToDropdownState = (state: TextInputState): DropdownInputState => {
    switch (state) {
      case TextInputState.DEFAULT:
        return DropdownInputState.DEFAULT;
      case TextInputState.FOCUSED:
        return DropdownInputState.FOCUSED;
      case TextInputState.ERROR:
        return DropdownInputState.ERROR;
      case TextInputState.SUCCESS:
        return DropdownInputState.SUCCESS;
      case TextInputState.DISABLED:
        return DropdownInputState.DISABLED;
      default:
        return DropdownInputState.DEFAULT;
    }
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <TextArea
            ...
            errorMessage={
              inputState === TextInputState.ERROR ? 'This is an error message' : undefined
            }
            successMessage={
              inputState === TextInputState.SUCCESS ? 'This is a success message' : undefined
            }
          />
        </div>
        <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <DropdownInput
            ...
            mandatory={showMandatory}
            options={['Option 1', 'Option 2', 'Option 3', 'Option 4', 'Option 5'].map(opt => ({
              label: opt,
              value: opt,
            }))}
