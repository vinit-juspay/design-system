      ...
      <div className="mt-6 space-y-8">
        <div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Checkbox 
              checked={true}
              subtext="Additional information below the checkbox"
            >
        ...
        <div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <Radio rightSlot={<HelpCircle className="w-3 h-3 text-gray-500" />} value="website">Website</Radio>
                <Radio value="android">Android App</Radio>
                <Radio value="ios">iOS App</Radio>
                <Radio 
                  value="social-media" 
                  subtext="Like WhatsApp, Facebook, Instagram"
                >
                  Social Media
                </Radio>
