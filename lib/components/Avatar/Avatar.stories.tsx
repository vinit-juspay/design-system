...
const meta: Meta<typeof Avatar> = {
  ...
  argTypes: {
    ...
    src: {
      control: 'text',
      description:
        'The URL of the image to display. If invalid or empty, fallback mechanisms are used.',
      table: { defaultValue: { summary: 'undefined' } },
    },
    alt: {
      control: 'text',
      description:
        'Alternative text for the image. Used for accessibility and to generate initials if `src` is missing and `fallback` is not provided.',
      table: { defaultValue: { summary: '""' } },
    },
    fallback: {
      control: 'text',
      description:
        'Custom text/initials to display when `src` is missing or invalid. Overrides initials generated from `alt`.',
      table: { defaultValue: { summary: 'undefined' } },
    },
    className: {
      control: 'text',
      description:
        'Optional additional CSS classes to apply to the root element. Useful for adding margins or other container-level styles. Example: `mt-2`',
      table: { defaultValue: { summary: 'undefined' } },
    },
  },
  args: {
