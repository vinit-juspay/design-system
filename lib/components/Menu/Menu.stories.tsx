...
const meta: Meta<typeof Menu> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A dropdown menu component with rich functionality including search, multi-select, submenu support and various item types.',
      },
    },
  },
  args: {
    ...
    items: [
      ...
      {
        content: 'Share',
        leftSlot: { content: <Share size={16} /> },
        onSelect: () => console.log('Share'),
      },
      { isSeparator: true },
      {
        content: 'Delete',
        leftSlot: { content: <Trash size={16} /> },
        color: 'danger',
  ...
  argTypes: {
    ...
    multiSelect: {
      ...
      table: {
        type: {
          summary:
            '{ enabled: boolean, selectedValues?: string[], onSelectionChange?: (values: string[]) => void }',
        },
        category: 'Features',
      },
    },
    ...
    items: [
      { content: 'View', onSelect: () => console.log('View') },
      {
        ...
        submenuItems: [
          {
            content: 'PDF',
            leftSlot: { content: <FileText size={16} /> },
            onSelect: () => console.log('PDF'),
          },
          {
            content: 'Excel',
            leftSlot: { content: <FileText size={16} /> },
            onSelect: () => console.log('Excel'),
          },
          {
            content: 'CSV',
            leftSlot: { content: <FileText size={16} /> },
