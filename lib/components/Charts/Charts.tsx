                  ...
                  <div className="bg-gray-0 shadow-lg flex flex-col gap-3 rounded-lg p-3 pl-2.5 border border-gray-150 w-[260px]">
                    <div className="pl-2 relative">
                      ...
                      <div className="flex flex-col">
                        <h3 className="text-body-md font-600 text-gray-900">
                          {capitaliseCamelCase(data.dataKey)}
                        </h3>
                        <label className="font-500 text-body-xs text-gray-400">
                          {data.name.split(' ')[1].replace(/[()]/g, '')}
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="pl-2 flex flex-col">
                      <label className="text-body-sm font-500 text-gray-400">
                        {capitaliseCamelCase(data.originalData.primary.name)}
                      </label>
                    ...
                    {data.originalData.aux && data.originalData.aux.length > 0 && (
                      <div className="flex flex-col gap-1 pt-3 pl-2 border-t border-gray-150">
                        {data.originalData.aux.map((auxItem: any, index: number) => (
                          ...
                          >
                            <span className="text-body-xs text-gray-400 truncate">
                              {auxItem.name}
                            </span>
              ...
              {pieData.map((entry, index) => {
                ...
                return (
                  <Cell
                    ...
                    opacity={
                      hoveredKey
                        ? hoveredKey === entry.dataKey
                          ? 1
                          : 0.3
                        : getElementOpacity(entry.dataKey)
                    }
                  />
                );
              })}
