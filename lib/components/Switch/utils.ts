...
export const getSwitchRootClassNames = (
  ...
  return cn(
    theme.baseStyles,
    theme.sizes[size].root,
    bgColorClass,
    className
  );
};

export const getSwitchThumbClassNames = (
  size: SwitchSize,
  checked: boolean,
): string => {
  const theme = themeConfig.euler.switch;
...
export const getSwitchLabelClassNames = (
  size: SwitchSize,
  disabled: boolean
): string => {
...
export const getSwitchSubtextClassNames = (
  size: SwitchSize,
  disabled: boolean
): string => {
  const theme = themeConfig.euler.radio;
  ...
  return cn(
    ...
    disabled && theme.disabledSubtext
  );
};
