export const themeConfig = {
  euler: {
    button: {
      ...
      buttonType: {
        ...
        secondary: {
          ...
          focusClasses:
            'focus-visible:outline-jp-gray-100 focus-visible:outline-2 focus:outline-jp-gray-100 focus:outline-2 focus:bg-white focus:border-jp-gray-150',
        },
        danger: {
    ...
    dropdownInput: {
      ...
      menu: {
        base: 'rounded-jp-xl bg-white p-1 shadow-md border border-gray-200 min-w-[8rem] z-50',
        item: {
          base: 'relative flex cursor-pointer select-none items-center rounded-jp-lg px-2 py-1.5 text-jp-body-md text-gray-800 outline-none transition-colors data-[highlighted]:bg-gray-50 focus:bg-gray-50',
          active: 'bg-gray-50 font-500',
    ...
    unitInput: {
      ...
      unit: {
        base: 'flex items-center justify-center text-jp-body-md font-500 text-jp-gray-500 h-full bg-gray-100',
        positions: {
    ...
    tabs: {
      ...
      variant: {
        boxed: {
          list: 'bg-gray-50 p-1 rounded-jp-lg',
          trigger:
        ...
        floating: {
          list: 'gap-2',
          trigger:
            'rounded-jp-lg text-jp-gray-500 data-[state=active]:bg-gray-100 data-[state=active]:text-gray-700 font-500 hover:text-gray-700 data-[state=active]:font-600',
        },
        underline: {
    ...
    otpInput: {
      ...
      digit: {
        ...
        states: {
          ...
          disabled: 'border-gray-200 bg-gray-100 text-jp-gray-400 cursor-not-allowed',
        },
      },
    },
    textArea: {
    ...
    alert: {
      base: {
        ...
        header: 'flex items-center gap-2 text-blue-800 font-600 text-jp-body-md',
        closeButton: 'text-jp-gray-400 hover:text-gray-600 h-5 w-5 flex items-center justify-center',
      ...
      typography: {
        title: 'font-600 text-jp-body-md text-jp-gray-700 tracking-normal',
        description: 'font-400 text-jp-body-md text-jp-gray-600 tracking-normal',
      },
      icon: {
        size: 'w-4 h-4',
        container: 'flex items-center gap-2',
      ...
      actionButton: {
        ...
        base: 'flex items-center justify-center whitespace-nowrap transition-all duration-200 disabled:pointer-events-none font-600 text-jp-body-md',
        colors: {
    ...
    chart: {
      ...
      base: {
        chartContainer: 'w-full h-full outline outline-1 outline-gray-300 rounded-jp-lg bg-white',
        ...
        chartLegend: {
          ...
          resetButton:
            'text-sm flex items-center justify-center text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-jp-sm h-4 w-4 shrink-0',
    ...
    menuv2: {
      baseStyles: 'rounded-jp-md shadow-md overflow-hidden bg-white border border-gray-200 py-1',
      animation: `
        .submenu-portal > div {
      ...
      menuItem: {
        baseStyles: 'flex items-center px-3 py-1.5 text-gray-600 text-jp-body-md font-500 ',
        types: {
          DEFAULT: 'cursor-pointer font-500 text-gray-600',
          MULTI_SELECT: 'cursor-pointer',
          ACTION: 'cursor-pointer font-500',
          LABEL: 'font-semibold text-xs text-jp-gray-500 uppercase tracking-wider py-1',
        ...
        submenu: {
          container:
            'bg-white border border-gray-200 rounded-jp-md shadow-lg py-1 min-w-[10rem] origin-top-left',
    ...
    breadcrumb: {
      ...
      item: {
        default: 'inline-flex items-center text-jp-gray-400 font-500 cursor-pointer',
      ...
      dropdown: {
        container:
          'absolute top-full left-0 z-50 py-1 bg-white rounded-jp-md shadow-lg border border-gray-200 min-w-48 translate-y-1',
    ...
    dateRangePicker: {
      base: {
        ...
        input:
          'flex items-center justify-between w-full px-3 py-2 border border-gray-300 rounded-jp-md shadow-sm bg-white text-sm text-gray-700 hover:border-jp-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 cursor-pointer',
      },
      input: {
      ...
      calendar: {
        container:
          'absolute z-10 mt-1 w-auto min-w-96 bg-white border border-gray-200 rounded-jp-lg shadow-lg',
        ...
        singleDate: 'bg-primary-500 rounded-jp-lg',
        rangeDay: 'bg-primary-50',
        todayDay: 'font-500',
        todayIndicator:
          'absolute w-1 h-1 bg-primary-500 rounded-full bottom-1 left-1/2 transform -translate-x-1/2',
        hoverState: 'hover:ring-1 hover:ring-inset hover:ring-primary-500 hover:rounded-jp-lg',
      },
      presets: {
        button:
          'px-3 py-1 text-sm rounded-jp-md border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500',
        activeButton: 'bg-primary-50 border-primary-500 text-primary-700',
      },
      timePicker: {
        container: 'p-4 border-t border-gray-200',
        input:
          'w-full px-3 py-2 border border-gray-300 rounded-jp-lg shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-gray-700',
      },
      text: {
        label: 'text-jp-gray-400',
        value: 'text-gray-600 font-500 text-jp-body-md',
    ...
    switch: {
      ...
      label: {
        baseStyles: 'ml-2 font-500 text-gray-700',
        disabled: 'text-gray-300',
      },
      subtext: 'text-jp-gray-400 font-normal',
      rightSlot: 'ml-2',
      ...
      groupLabel: 'text-sm font-500 text-gray-700 mb-2',
      sizes: {
        sm: {
          root: 'w-6 h-3',
    ...
    avatar: {
      ...
      sizes: {
        ...
        regular: 'h-8 w-8 text-jp-body-sm text-500 text-gray-900',
        md: 'h-10 w-10 text-jp-body-md text-500 text-gray-900',
        lg: 'h-12 w-12 text-jp-body-lg text-500 text-gray-900',
    ...
    avatarGroup: {
      base: {
        ...
        overflowCounter:
          'relative inline-flex cursor-pointer items-center justify-center rounded-full border-2 border-transparent bg-gray-900 text-gray-50 font-500 transition-colors',
      },
    ...
    accordion: {
      ...
      type: {
        border: {
          container: 'space-y-6',
          item: 'border border-gray-200 rounded-jp-lg overflow-hidden',
    ...
    popover: {
      base: {
        container:
          'flex flex-col gap-3 bg-jp-gray-0 rounded-2xl p-4 pt-3 z-50 fixed shadow-md outline-none duration-150 max-w-[480px] min-w-[280px]',
    ...
    dataTable: {
      ...
      header: {
        ...
        description: 'text-sm text-jp-gray-500',
      },
      filters: {
      ...
      td: {
        base: 'px-3 py-2 text-jp-body-md text-gray-800 font-500',
        variant: {
          default: '',
          compact: 'px-2 py-1',
    ...
    textField: {
      base: {
        inputContainer:
          'flex bg-white border relative rounded-jp-xl transition-all duration-200 focus-within:outline-2',
      ...
      status: {
        default: 'border-jp-gray-300 bg-white',
      ...
      dropdown: {
        base: 'rounded-jp-xl bg-white p-1 shadow-md border border-jp-gray-200 min-w-[8rem] z-50',
        item: {
    ...
    //   base:
    //     'flex z-50 items-center overflow-hidden bg-jp-gray-900 text-jp-gray-0 font-500 shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
    //   arrow: 'before:bg-jp-gray-900 before:content-[""]',
    //   sizes: {
    //     xs: 'max-w-[150px] p-1.5 text-xs rounded-jp-lg',
    //     sm: 'max-w-[200px] p-2 text-xs rounded-jp-lg',
    //     md: 'max-w-[250px] p-2 text-sm rounded-jp-lg',
    //     lg: 'max-w-[300px] p-2 text-sm rounded-jp-lg',
    //     xl: 'max-w-[350px] p-2 text-sm rounded-jp-lg',
    //   },
    //   baseStyles: 'items-center text-jp-gray-0',
    //   tooltipArrow: 'relative fill-jp-gray-900',
    // },
    // tabs: {
    //   base: {
    //     horizontal: {
    ...
    //       item: {
    //         base: 'inline-flex px-2.5 py-1.5 text-jp-body-md focus:outline-none',
    //         boxed:
    //           'rounded-jp-lg text-jp-gray-500 data-[state=active]:bg-jp-gray-0 data-[state=active]:text-jp-gray-700 data-[state=active]:shadow-sm hover:bg-jp-gray-0 data-[state=active]:font-600 hover:text-jp-gray-600 font-500',
    //         pill:
    ...
    //       },
    //       bordered: {
    //         list: 'border-b border-jp-gray-200',
    //         item:
    //           'border-b-2 border-transparent text-jp-gray-500 relative data-[state=active]:border-jp-gray-700 data-[state=active]:text-jp-gray-700 font-500 hover:text-jp-gray-600  data-[state=active]:z-10 data-[state=active]:font-600',
    //       },
    //       minimal: {
    //         list: 'bg-transparent',
    //         item:
    //           'text-jp-gray-500 data-[state=active]:text-jp-gray-700 font-500 hover:text-jp-gray-600 data-[state=active]:font-600',
    //       },
    //     },
    //     vertical: {
    //       list: 'flex flex-col gap-y-1',
    //       item: {
    //         base: 'block px-2.5 py-1.5 text-jp-body-md focus:outline-none w-full text-left',
    //         boxed:
    //           'rounded-jp-lg text-jp-gray-500 data-[state=active]:bg-jp-gray-50 data-[state=active]:text-jp-gray-700 hover:bg-jp-gray-50 data-[state=active]:font-600 hover:text-jp-gray-600 font-500',
    //         pill:
    //           'rounded-jp-lg text-jp-gray-500 data-[state=active]:bg-jp-gray-100 data-[state=active]:text-jp-gray-700 font-500 hover:text-jp-gray-700 data-[state=active]:font-600',
    //       },
    //       bordered: {
    //         list: 'border-l border-jp-gray-200',
    //         item:
    //           'border-l-2 ml-[-2px] border-transparent text-jp-gray-500 relative data-[state=active]:border-jp-gray-700 data-[state=active]:text-jp-gray-700 font-500 hover:text-jp-gray-600 data-[state=active]:z-10 data-[state=active]:font-600',
    //       },
    //       minimal: {
    //         list: 'bg-transparent',
    //         item:
    ...
    textarea: {
      ...
      status: {
        ...
        filled: 'border-jp-gray-300 bg-white',
        error: 'border-jp-red-500 focus-within:border-jp-red-500 focus-within:ring-jp-red-100',
    ...
    toast: {
      ...
      positions: {
        heading: 'text-jp-body-lg font-500 text-jp-gray-25',
        message: 'text-jp-body-md font-400 break-words text-jp-gray-300',
      },
      action: 
        'text-jp-body-md font-600 text-jp-gray-100 hover:text-jp-gray-0 justify-start active:text-jp-gray-0 focus:text-jp-gray-0',
      variant: {
        primary: {
          backgroundColor: 'bg-jp-gray-800',
